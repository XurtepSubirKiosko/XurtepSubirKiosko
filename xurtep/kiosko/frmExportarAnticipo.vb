...
Public Class frmExportarAnticipo
            ...
            If lsvLista.CheckedItems.Count > 0 Then
                ...
                For Each producto As ListViewItem In lsvLista.CheckedItems
                    ...
                    If rwUsuarioK Is Nothing = False Then
                        'insertamos el pago
                        'Insertar nuevo
                        SQL = "EXEC setanticipoInsertar    0," & rwUsuarioK(0)("iIdUsuarioK").ToString() & ",'" & Date.Parse(Trim(producto.SubItems(1).Text)).ToShortDateString() & "',1,"
